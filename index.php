...
<html lang="en">
    <head>
                ...
                <script async src="https://www.googletagmanager.com/gtag/js?id=UA-195672707-1"></script>
                <script>
                window.dataLayer = window.dataLayer || [];
                function gtag(){dataLayer.push(arguments);}
                gtag('js', new Date());

                gtag('config', 'UA-195672707-1');
                </script>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        <li><a href="https://www.facebook.com/krish.kalathiya"><i class="ion-social-facebook"></i></a></li>
                        <li><a href="https://twitter.com/Krish93312541"><i class="ion-social-twitter"></i></a></li>
                        <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
                        <li><a href="https://www.instagram.com/cruxdecusstapermuta/"><i class="ion-social-instagram"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="row">
                <p>
                    Made by K.K. as a Guided Project during the 'Build Responsive Real World Websites with HTML5 and CSS3' course on Udemy.com
                </p>
            </div>
        </footer>
